    ...
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center p-8 text-center text-white">
        ...
        <div className="relative my-8 w-full max-w-[300px]">
          ...
          <div className="relative flex justify-center text-[10px] uppercase font-black tracking-widest"><span className="bg-black px-4 text-white/40">Or Secure Access</span></div>
        </div>

        {currentUser ? (
          <div className="flex items-center gap-3 p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl">
            <div className="w-8 h-8 rounded-full bg-emerald-500 flex items-center justify-center font-black text-black">
              {currentUser.email?.[0].toUpperCase()}
            </div>
            <div className="text-left">
              <p className="text-xs font-bold text-emerald-400">{currentUser.email}</p>
              <p className="text-[9px] uppercase font-bold tracking-wider text-white/40">Verified Cloud Session</p>
            </div>
            <button 
              onClick={() => {
                localStorage.setItem('APP_UNLOCKED', 'true');
              ...
              className="ml-4 px-4 py-2 bg-emerald-500 text-black font-black uppercase text-xs tracking-wider rounded-xl hover:bg-emerald-400 transition-colors cursor-pointer"
            >
              Enter
            </button>
          </div>
          ...
          <div className="flex flex-col items-center gap-3 w-full max-w-[300px]">
            <button 
              ...
              className="w-full py-4 bg-white/10 hover:bg-white/15 text-white font-black uppercase text-xs tracking-wider rounded-2xl transition-all cursor-pointer flex items-center justify-center gap-3 border border-white/10 shadow-xl"
            >
            ...
            <button 
              ...
              className="text-[10px] text-emerald-400 hover:text-emerald-300 font-bold tracking-wider underline cursor-pointer mt-2"
            >
              (Dev Quick Entry: Unlock with Master Passcode)
            </button>
          </div>
        )}
